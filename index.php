...
<body class="home">
        ...
        <section class="hero">
            <div class="hero-slider">
                <div class="hero-slide active" style="background-image: url('images/img/slider-img/cake.jpg')"></div>
                <div class="hero-slide" style="background-image: url('images/img/slider-img/candle.jpg')"></div>
                <div class="hero-slide" style="background-image: url('images/img/slider-img/craft.jpg')"></div>
                <div class="hero-slide" style="background-image: url('images/img/slider-img/food.jpg')"></div>
                <div class="hero-slide" style="background-image: url('images/img/slider-img/pickle.jpg')"></div>
                <div class="hero-slide" style="background-image: url('images/img/slider-img/spices.jpg')"></div>
            </div>
                ...
                <div class="container text-center hero-text">
                   ...
                   <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Choose Homemade Shop</h4> </div>
    ...
    <!-- Hero Slider Auto-scroll Script -->
    <script>
